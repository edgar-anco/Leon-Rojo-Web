...
export const Gradient = () => {
  return (
    <>
      <div className="relative z-1 h-6 mx-2.5 bg-color-1 shadow-xl rounded-b-[1.25rem] lg:h-6 lg:mx-8 opacity-50" />
      <div className="relative z-1 h-6 mx-6 bg-color-1 shadow-xl rounded-b-[1.25rem] lg:h-6 lg:mx-20 opacity-25" />
    </>
  );
};
